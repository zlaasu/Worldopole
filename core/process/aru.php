...
switch ($request) {
	...
	case 'gym_map':
		...
		// $req = "SELECT gym_id, team_id, latitude, longitude, (CONVERT_TZ(last_scanned, '+00:00', '".$time_offset."')) AS last_scanned, (6 - slots_available) AS level FROM gym WHERE true" . ($wawa ? $limit : '');
		$result = $mysqli->query($req);
